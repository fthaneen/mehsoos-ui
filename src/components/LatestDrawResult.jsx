    ...
    >
      ...
      >
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl md:text-3xl font-bold text-blue-600">LATEST DRAW RESULT</h2>
            ...
            {matchResults.map((result, index) => (
              <div key={index} className="flex justify-between items-center">
                <div>
                  ...
                  <span className="font-medium text-blue-600">{result.match}</span>
                </div>
                <div>
                  <span className="text-gray-500">Winners</span>{" "}
                  <span className="font-medium text-blue-600">{result.winners}</span>
                </div>
              </div>
            ))}
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              {luckyResults.map((result, index) => (
                <div key={index} className="flex justify-between items-center">
                  <span className="font-medium text-blue-600">{result.ticket}</span>
